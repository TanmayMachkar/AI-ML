...
data = pd.read_csv(r"C:\Users\ADMIN\AI-ML\Matplotlib\data1.csv")
ages = data['Age']
...
# plt.fill_between(ages, py_salaries, overall_median, where = (py_salaries > overall_median), interpolate = True, alpha = 0.25) #fill_between(x axis, what we want to fill upto bottom/top of graph, , , , how much we want to see thru it)
