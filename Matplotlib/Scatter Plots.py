...
# cbar = plt.colorbar()
# cbar.set_label("Satifaction")

data = pd.read_csv(r'C:\Users\ADMIN\AI-ML\Matplotlib\2019-05-31-data.csv')
...
# use log scale to lessen how much outliers skew the plot
plt.xscale("log")
plt.yscale("log")
